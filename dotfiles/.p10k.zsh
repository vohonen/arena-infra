...
# Generated by Powerlevel10k configuration wizard on 2025-04-28 at 10:50 UTC.
...
() {
  ...
  function prompt_example() {
    p10k segment -f 208 -i $MACHINE_NAME
  }

  # Custom segment to display a fixed name
  function prompt_custom_name() {
    p10k segment -f blue -t 'CustomName' # Change 'blue' and 'CustomName' as needed
  }
  ...
  function instant_prompt_custom_name() {
    prompt_custom_name
  }
